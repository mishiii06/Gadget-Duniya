<html>
    ...
    <body background="Images/background.jpg">
        ...
        <div style="width:15%; height: 89%; background-color: darkblue;margin-top:-566px;margin-left:0%">
            <table width="100%" height="10%" border="4" style="background-color: darkblue; font-size: 30px;color: white;text-align: center;";>
                <tr>
                    <td>
                        Best Selling
                    </td>
            ...
            <div style="width:100%; height: 25.5%; background-color: lightblue;">
            Product 1
            </div><hr>
            ...
            <div style="width:100%; height: 8%; background-color: darkblue;">
            <table width="100%" height="100%" style="background-color: darkblue; font-size: 30px;color: white;text-align: center;font-family: arial;">
                <tr>
                    <td>
                        V
                    </td>
