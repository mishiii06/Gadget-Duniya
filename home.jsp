<html>
    ...
    <body background="Images/background.jpg">
        <form>   
                <input type="text" autocomplete="off" placeholder=" Search...."name="Search" style='margin-left:810px;'>   
        ...
        <div style="width:40%;height:65%;margin-left:85px;margin-top:105px;background-color:white;opacity: 0.6;">         
        </div>
