...
<%
    ...
    PreparedStatement st=con.prepareStatement("insert into customize values(?,?,?,?,?)");
        ...
        <div style="width: 40%; height: 50%; background-color: white; margin-left: 45%; margin-top: 4%; margin-left: 30%;">
            ...
            <table width="100%" height="100%" border="1" cellspacing="2" style="background-color: lightblue; color: darkblue; font-weight: bold;">
                ...
                <tr align="center">
                    ...
                    <td><input type="text" placeholder="Enter part to customize..." name="part" style="width: 80%"</td>
                </tr>
            </table>
        </div>
         
            <input name="submit" type="submit" style="height: 30px; width: 80px; margin-left: 47.5%; margin-top: 10px; font-weight: bold; background-color: whitesmoke;font-size: 18px;color: darkblue;"></button>   
        </form>
    </body>
</html>