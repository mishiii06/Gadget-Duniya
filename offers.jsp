<html>
    ...
    <body background="background.jpg">
        ...
        <div style="width:57%;height:20px;margin-left:650px;margin-top:78px;background-color: white;">
            <table width= "80%" height="30px" border="0" style='margin-top:-80px;background-color: white;margin-left: 150px'>
                <tr align="center">
                    ...
                    <td class="tdtheme"><a href=".jsp"><img src='microphone.jpg' width='30px' height='30px'></a></td>
        ...
        <div style="width: 49%; height: 20%; background-color: lightblue; margin-top: 5%;"> Offer Details
            <div style="width: 24.5%; height: 100%; background-color: darkblue; color: white">
                Offer 1
            </div>
        </div>
        
        <div style="width: 49%; height: 20%; background-color: lightblue; margin-top: -149px; margin-left: 51%">Offer Details
            <div style="width: 24.5%; height: 100%; background-color: darkblue;color: white">
                Offer 2
            </div>
        </div>
        
        <div style="width: 49%; height: 20%; background-color: lightblue; margin-top: 3%">Offer Details
            <div style="width: 24.5%; height: 100%; background-color: darkblue;color: white">
                Offer 3
            </div>
        </div>
